...
import buzzlanding from '../assets/buzz-landing.png'
import { Link } from 'react-router-dom'
import '../pages/ItServicePage.css'

export const BuzzbeePage = () => {
  return (
    <div className='p-5' style={{ background: 'black', color: 'white' }}>
            <div className='d-flex justify-content-center align-items-center' style={{ flexDirection: 'column' }}>
                <h1 className='text-center'>Buzz Bee</h1>
                <img src={buzzlanding} alt='IT' className='img-fluid mt-5 landingImg' style={{ width: '40%' }} />
                ...
                <div className='d-flex justify-content-between align-items-center gap-5'>
                    ...
                    <Link to='/CyberPage'><div className="circle"></div></Link>
                </div>
                <Link to="/Buzzbee">
